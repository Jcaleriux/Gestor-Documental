const NEXT_STATE_CONFIG = {
  en_aprobacion_gerencia: { label: 'Enviar a tesoreria para caratulas', estado: 'en_revision_tesoreria_1' },
  en_revision_tesoreria_1: { label: 'Enviar a gerencia contable', estado: 'en_aprobacion_gerencia_contable' },
