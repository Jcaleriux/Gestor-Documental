...
export const buildFacturaDetalleContabilizacionStateOutput = (data) => ({
  ...
  documentosRespaldoActuales: data.documentosRespaldoActuales,
  ...
  centrosCostoModalOpen: data.centrosCostoModalOpen,
  setCentrosCostoModalOpen: data.setCentrosCostoModalOpen,
  centrosCostoTargetLineId: data.centrosCostoTargetLineId,
  setCentrosCostoTargetLineId: data.setCentrosCostoTargetLineId,
  centrosCostoLoading: data.centrosCostoLoading,
  centrosCostoError: data.centrosCostoError,
...
export const buildFacturaDetalleActionsOutput = (actions) => ({
  ...
  desenlazarOrdenCompra: actions.desenlazarOrdenCompra,
  abrirAsociarNotaCredito: actions.abrirAsociarNotaCredito,
  asociarNotaCredito: actions.asociarNotaCredito,
  addCentroCostoLinea: actions.addCentroCostoLinea,
  removeCentroCostoLinea: actions.removeCentroCostoLinea,
  actualizarMontoCentroCosto: actions.actualizarMontoCentroCosto,
  abrirSelectorCentrosCosto: actions.abrirSelectorCentrosCosto,
  cerrarSelectorCentrosCosto: actions.cerrarSelectorCentrosCosto,
  seleccionarCentroCostoEnLinea: actions.seleccionarCentroCostoEnLinea,
  ...
  verDocumentoRespaldo: actions.verDocumentoRespaldo,
  subirDocumentosRespaldo: actions.subirDocumentosRespaldo,
  eliminarDocumentoRespaldo: actions.eliminarDocumentoRespaldo,
